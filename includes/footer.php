    ...
    <div class="row g-5 align-items-start">
      ...
      <div class="col-md-2 mb-4 mb-md-0 footer-quick-links">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="../pages/travelguide.php" class="text-white text-decoration-none">Travel Guide</a></li>
          <li><a href="../pages/about.php" class="text-white text-decoration-none">About Us</a></li>
          <li><a href="../pages/contact.php" class="text-white text-decoration-none">Contact Us</a></li>
        </ul>
      </div>
      <!-- Contact Info -->
      <div class="col-md-3 mb-4 mb-md-0">
